...
export function modalWindows() {
    ...
    // const filmCardModal = new Modal("кнопка відкриття модалки", ".film-modal__close-btn", ".film-modal-overlay", ".film-modal");
    // filmCardModal.openBtn.addEventListener("click", filmCardModal.openModal.bind(filmCardModal));
};